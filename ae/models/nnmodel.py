...
class NNModel:
    ...
    def make_model(self):
        ...
        lstm = kl.LSTM(50, input_shape=(1, self.input_shape), return_sequences=True, activity_regularizer=regularizers.l2(0.003),
                       recurrent_regularizer=regularizers.l2(0), dropout=0.2, recurrent_dropout=0.2)(input_data)
        perc = kl.Dense(50, activation="sigmoid", activity_regularizer=regularizers.l2(0.005))(lstm)
        lstm2 = kl.LSTM(20, activity_regularizer=regularizers.l2(0.01), recurrent_regularizer=regularizers.l2(0.001),
    ...
    def train_model(self, x, y, epochs, model_name, save_model=True):
        ...
        self.model.fit(train_x, train_y, epochs=epochs, optimizer=opt)
