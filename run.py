...
print('Loading data...')
a_train_x = pd.read_csv(f'./sample_data/processed_data/autoencoder_data/train_x.csv', index_col=0)
a_train_y = pd.read_csv(f'./sample_data/processed_data/autoencoder_data/train_y.csv', index_col=0)
a_test_x = pd.read_csv(f'./sample_data/processed_data/autoencoder_data/test_x.csv', index_col=0)
a_test_y = pd.read_csv(f'./sample_data/processed_data/autoencoder_data/test_y.csv', index_col=0)
